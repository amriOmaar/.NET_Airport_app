    ...
    namespace AM.ApplicationCore.Domain
    {
        ...
        // Staffs
        public static Staff captain = new Staff { Fullname = new FullName { FirstName = "captain", LastName = "captain" }, EmailAdresse = "captain.captain@gmail.com", BirthDate = new DateTime(1965, 01, 01), EmploymentDate = new DateTime(1999, 01, 01), Salary = 99999 };
        public static Staff hostess1 = new Staff { Fullname = new FullName { FirstName = "hostess1", LastName = "hostess1" }, EmailAdresse = "hostess1.hostess1@gmail.com", BirthDate = new DateTime(1995, 01, 01), EmploymentDate = new DateTime(2020, 01, 01), Salary = 999 };
        public static Staff hostess2 = new Staff { Fullname = new FullName { FirstName = "hostess2", LastName = "hostess2" }, EmailAdresse = "hostess2.hostess2@gmail.com", BirthDate = new DateTime(1996, 01, 01), EmploymentDate = new DateTime(2020, 01, 01), Salary = 999 };
        //// Travellers
        public static Traveller traveller1 = new Traveller { Fullname = new FullName { FirstName = "traveller1", LastName = "traveller1" }, EmailAdresse = "traveller1.traveller1@gmail.com", BirthDate = new DateTime(1980, 01, 01), HealthInformation = "no troubles", Nationality = "American" };
        public static Traveller traveller2 = new Traveller { Fullname = new FullName { FirstName = "traveller2", LastName = "traveller2" }, EmailAdresse = "traveller2.traveller2@gmail.com", BirthDate = new DateTime(1981, 01, 01), HealthInformation = "Some troubles", Nationality = "French" };
        ...
        public static Traveller traveller4 = new Traveller { Fullname = new FullName { FirstName = "traveller4", LastName = "traveller4" }, EmailAdresse = "traveller4.traveller4@gmail.com", BirthDate = new DateTime(1983, 01, 01), HealthInformation = "Some troubles", Nationality = "American" };
        public static Traveller traveller5 = new Traveller { Fullname = new FullName { FirstName = "traveller5", LastName = "traveller5" }, EmailAdresse = "traveller5.traveller5@gmail.com", BirthDate = new DateTime(1984, 01, 01), HealthInformation = "Some troubles", Nationality = "Spanish" };
        // Flights
